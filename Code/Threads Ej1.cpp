/*Modificar el código de ejemplo creando el struct con new, en lugar de hacer la
reserva de memoria del heap (alloc) explícita.*/
#include <windows.h>
#include <tchar.h>
#include <strsafe.h>
...
int main() { //_tmain
    ...
    for (int i = 0; i < MAX_THREADS; i++) {
      ...
      //array in static memory but each position in the array points to heap!
        pDataArray[i] = new MyData{ i,i + 100 }; //this hides the memory allocation in the heap
        ...
        //pDataArray[i]->tid = i; //tell each thread the position in our array (mainly for debugging purposes)
